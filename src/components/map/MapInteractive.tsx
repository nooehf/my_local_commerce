...
export default function MapInteractive({ businesses }: { businesses: Business[] }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row flex-1 max-w-7xl mx-auto w-full px-4 py-6 gap-6">
      ...
      {/* Sidebar */}
      <aside className="w-full lg:w-[340px] shrink-0 flex flex-col h-full gap-4">
        {/* Search Bar */}
        ...
        <div className="flex-1 overflow-y-auto space-y-3 pr-2 custom-scrollbar lg:max-h-[600px]">
      ...
      {/* Map */}
      <div className="w-full lg:flex-1 h-[500px] lg:h-auto min-h-[500px] lg:min-h-[700px] rounded-3xl overflow-hidden ring-1 ring-slate-200/80 shadow-lg relative z-0">
